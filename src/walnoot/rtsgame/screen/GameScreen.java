...
public class GameScreen extends Screen {
	...
	public GameScreen(RTSComponent component, InputHandler input){
		...
		map.addEntity(new SheepEntity(map, 4, goodYPos+3)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+4)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+5)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+6)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+7)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+8)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+9)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+10)); //voor de test, later weghalen
		map.addEntity(new SheepEntity(map, 4, goodYPos+11)); //voor de test, later weghalen
